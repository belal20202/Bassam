...
export const DEFAULT_PLAYER_DATA: PlayerData = {
  ...
  biomeVisits: {
    KARKH_MANSOUR: 0,
    KARKH_KADHIMIYA: 0,
    KARKH_YARMOUK_DORA: 0,
    KARKH_JADRIYA_BRIDGE: 0,
    KARKH_AMIRIYAH_KHADRAA: 0,
    KARKH_SAYDIYA_BAYAA: 0,
    KARKH_GHAZALIYA_SHUULA: 0,
    KARKH_HAI_ALJAMIA: 0,
    RUSAFA_MUTANABBI_QISHLA: 0,
    RUSAFA_RASHEED_TAHRIR: 0,
    RUSAFA_KARRADA_NIGHT: 0,
    RUSAFA_ADHAMIYA_RIVER: 0,
    RUSAFA_PALESTINE_ZAYOUNA: 0,
    RUSAFA_SALIHIYA_SINAK: 0,
    RUSAFA_BAB_SHARQI_SAADOUN: 0,
    RUSAFA_ZAAFARANIYA_DIYALA: 0,
  },
  careerHistory: [],
  ...
  unlockedItems: [
    'outfit_baghdad_street',
    'shoes_classic_runner',
    'trail_dust_clean',
    'acc_none',
  ],
  customization: {
    equippedOutfit: 'outfit_baghdad_street',
