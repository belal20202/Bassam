...
const BIOME_NAMES: Record<BiomeType, { title: string; district: string; color: string }> = {
  BAGHDAD: { title: 'بغداد', district: 'العاصمة', color: 'from-amber-500 to-yellow-400' },
  BASRA: { title: 'البصرة', district: 'الجنوب', color: 'from-blue-500 to-cyan-400' },
  NINEVEH: { title: 'نينوى', district: 'الشمال', color: 'from-emerald-500 to-teal-400' },
  ERBIL: { title: 'أربيل', district: 'إقليم كردستان', color: 'from-yellow-500 to-amber-600' },
  SULAYMANIYAH: { title: 'السليمانية', district: 'إقليم كردستان', color: 'from-purple-500 to-indigo-400' },
  DUHOK: { title: 'دهوك', district: 'إقليم كردستان', color: 'from-sky-500 to-blue-600' },
  KIRKUK: { title: 'كركوك', district: 'الشمال', color: 'from-orange-500 to-amber-600' },
  BABYLON: { title: 'بابل', district: 'الفرات الأوسط', color: 'from-amber-600 to-yellow-600' },
  KARBALA: { title: 'كربلاء المقدسة', district: 'الفرات الأوسط', color: 'from-emerald-600 to-green-500' },
  NAJAF: { title: 'النجف الأشرف', district: 'الفرات الأوسط', color: 'from-teal-500 to-cyan-400' },
  ANBAR: { title: 'الأنبار', district: 'الغرب', color: 'from-amber-500 to-orange-500' },
  DIYALA: { title: 'ديالى', district: 'الوسط', color: 'from-lime-500 to-emerald-400' },
  SALADIN: { title: 'صلاح الدين', district: 'الوسط والشمال', color: 'from-rose-500 to-red-600' },
  WASIT: { title: 'واسط', district: 'الوسط والجنوب', color: 'from-teal-500 to-cyan-400' },
  MAYSAN: { title: 'ميسان', district: 'الجنوب', color: 'from-cyan-500 to-blue-500' },
  DHI_QAR: { title: 'ذي قار', district: 'الجنوب', color: 'from-purple-600 to-pink-500' },
  MUTHANNA: { title: 'المثنى', district: 'الجنوب والبادية', color: 'from-yellow-600 to-amber-500' },
  QADISIYYAH: { title: 'الديوانية', district: 'الفرات الأوسط', color: 'from-red-500 to-rose-400' },
  DIWANIYAH: { title: 'الديوانية', district: 'الفرات الأوسط', color: 'from-red-500 to-rose-400' },
};
